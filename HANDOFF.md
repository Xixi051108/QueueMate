...
- 2026-08-16 首次 GitHub Actions 远程运行已触发，但基础构建 `31953449543` 和全量回归 `31953449592` 均在前端依赖安装步骤失败：工作流固定 pnpm 9，而当前工作区配置需要 pnpm 11.19.0。后端、MySQL 和服务启动步骤此前均成功；修复工作流版本仍需用户明确授权后单独提交。
